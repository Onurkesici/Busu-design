                    ...
                    <div class="x_content">
                        ...
                        <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <?php
                                    if (strlen($projelercek['projeler_img_4']) > 0) { ?>

                                        <img width="200" src="../../<?php echo $projelercek['projeler_img_4'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file" id="first-name" name="projeler_img_4"
                            ...
                            <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="submit" name="projelerfotoduzenle_4"
                        ...
                        <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="projeler_ustbaslik_4"
                                        value="<?php echo $projelercek["projeler_ustbaslik_4"] ?>" required="required"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="projeler_baslik_4"
                                        value="<?php echo $projelercek["projeler_baslik_4"] ?>" required="required"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="projeler_aciklama_4"
                                        value="<?php echo $projelercek["projeler_aciklama_4"] ?>" required="required"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="projelerkaydet_4"
