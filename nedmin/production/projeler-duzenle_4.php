                    ...
                    <div class="x_content">
                        ...
                        <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"
                            ...
                            <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="submit" name="projelerfotoduzenle_4" class="btn btn-primary">Güncelle</button>
                            </div>
                        ...
                        <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="projelerkaydet_4" class="btn btn-success">Guncelle</button>
                                </div>
                            </div>
